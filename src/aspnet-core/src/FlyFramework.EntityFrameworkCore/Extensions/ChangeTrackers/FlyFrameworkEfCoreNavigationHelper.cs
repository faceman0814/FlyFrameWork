...
/// </summary>
public class FlyFrameworkEfCoreNavigationHelper : ITransientDependency
{
    protected Dictionary<string, FlyFrameworkEntityEntry> EntityEntries { get; } = new();
    ...
    protected virtual void EntityEntryTrackedOrStateChanged(EntityEntry entityEntry)
    {
        ...
        EntityEntries.Add(entryId, new FlyFrameworkEntityEntry(entryId, entityEntry));
    }
